...
Purpose:
    ...
    bluesky networks as compared with the naive network. Also, calculate the mean
...
CENTRALITIES_DIR = (
    "/data_volume/cascade_reconstruction/bluesky/networks_stats/centralities"
)
OUTPUT_DIR = (
    "/data_volume/cascade_reconstruction/bluesky/networks_stats/strength_differences"
)
