"""
Purpose: Create multiple versions of the Bluesky reshare network from
...
Output: Multiple versions of the reshare network
...
# Constants
# You need to update the below variable for each gamma value and move the results
# into proper directories named `gamma_0_25`, `gamma_0_5`, `gamma_0_75`
DATA_DIR = "/data_volume/cascade_reconstruction/pdi_bluesky/gamma_0_75"
...
def generate_cascade_numv_map(data_dir):
    """
    Generate a dictionary mapping cascade id to number of versions created
